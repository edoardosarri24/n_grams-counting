...
We have evaluated the different execution times before and after the implementation of the arena allocator; before this type of allocation we used a huge number of \texttt{malloc} operations. The input file used and the old code are no longer available.
...
\begin{itemize}
    \item 100KB \\
        The three most frequent 3-grams are \textit{randallsville new york}, \textit{variety of quartz} and \textit{in the uk}; their frequencies are respectively 24, 10 and 9.
    \item 100MB \\
        The three most frequent 3-grams are \textit{one of the}, \textit{as well as} and \textit{a lot of}; their frequencies are respectively 7774, 6995 and 4264.
    \item 500MB \\
        The three most frequent 3-grams are \textit{one of the}, \textit{as well as} and \textit{a lot of}; their frequencies are respectively 38758, 34863 and 20851.
    \item 1GB \\
        The three most frequent 3-grams are \textit{one of the}, \textit{as well as} and \textit{a lot of}; their frequencies are respectively 53934, 48790 and 29367.
    \item 1.5GB \\
        The three most frequent 3-grams are \textit{one of the}, \textit{as well as} and \textit{a lot of}; their frequencies are respectively 118445, 106364 and 64775.
    \item 2GB \\
        The three most frequent 3-grams are \textit{one of the}, \textit{as well as} and \textit{a lot of}; their frequencies are respectively 157788, 142530 and 86345.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table is irrelevant (i.e., the system prints 0.0000 with 4 decimal places) in this case.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table is: 0.0060 seconds.
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table: 0.0150.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table is: 0.0118 seconds.
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table: 0.0254.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table is: 0.0197 seconds.
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table is: 0.0507 seconds.
...
The problem in this case is the running out of mempory. With 2 GB input data there are too much $n$-grams to store in each local hash table in the parallel version.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Populating hash table time: 333.3192 seconds, i.e. 5 minutes and 30 seconds.
        \item Freeing the hash table: 0.0367 seconds.
    ...
    \begin{itemize}
        ...
        \item Freeing the hash table: 0.1226 seconds.
